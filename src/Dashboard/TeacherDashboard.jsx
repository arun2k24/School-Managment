...
function TeacherDashboard() {
  ...
  return (
    <div className="flex w-screen">
      <aside className="w-1/5 bg-blue-300 text-white p-6">
      ...
      <main className="w-4/5 bg-gray-100 p-10">
        {/* Profile Section */}
        <div className="bg-yellow-200 shadow-md rounded-lg p-6 w-full mx-auto my-6" id="profile">
          ...
          {isEditing ? (
            <form onSubmit={handleUpdate}>
              ...
              <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700 mr-2">
                Save
              </button>
            ...
            <>
              <h3 className="font-bold">{teacherInfo.name}</h3>
        ...
        <div id="notifications" className="mt-10">
          ...
          <p>Your notifications will go here...</p>
        </div>
      </main>
    </div>
  );
