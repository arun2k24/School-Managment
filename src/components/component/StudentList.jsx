...
const SubjectList = () => {
  // State to hold subjects and new subject input
  ...
  const handleAddSubject = () => {
    ...
    setNewSubject({ name: '', teacher: '' }); // Clear the input fields
  };
            ...
            <tr key={subject.id}>
              ...
              <td className="border px-4 py-2">
                <input
                  type="text"
                  value={subject.name}
                  onChange={(e) => subject.name = e.target.value} // temporary, should use state in production
              ...
              <td className="border px-4 py-2">
                <input
                  ...
                  onChange={(e) => subject.teacher = e.target.value} // temporary, should use state in production
                  className="border px-4 py-2"
                />
              </td>
              <td className="border px-4 py-2">
