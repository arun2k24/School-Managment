...
function Contact() {
  return (
    <div className="container mx-auto my-10 p-6 text-center w-screen bg-gray-300">
      ...
      <div className="flex flex-col md:flex-row justify-around items-center mb-8 space-y-6 md:space-y-0">
        ...
        <div className="flex flex-col items-center">
          <h2 className="text-xl font-bold mb-2">School Address</h2>
        ...
        <div className="flex flex-col items-center">
          ...
          <p>General: info@school.com</p>
          <p>Admissions: admissions@school.com</p>
        </div>
      </div>
