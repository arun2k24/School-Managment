...
const Login = () => {
  ...
  return (
    <div className="flex h-screen bg-cover justify-center items-center bg-center" style={{ backgroundImage: `url('https://wallpaperaccess.com/full/1172344.jpg')` }}>
      <div className="w-full lg:w-1/2 flex items-center justify-center h-full p-4">
        <div className="w-full max-w-md bg-white bg-opacity-80 p-8 border border-gray-300 shadow-lg rounded-md">
          ...
          {/* Toggle between Admin and Student/Teacher */}
